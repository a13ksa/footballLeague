...
if(isset($_GET['edit_id'])) {
    $sql_query="SELECT * FROM treneri WHERE idTrenera=".$_GET['edit_id'];
...
if(isset($_POST['btn-update'])) {
    ...
    $sql_query = "UPDATE treneri SET ime='$ime',prezime='$prezime',drzavljanstvo='$drzavljanstvo',datumRodjenja='$datumRodjenja',idKluba='$idKluba' WHERE idTrenera=".$_GET['edit_id'];
    // sql query for update data into database
