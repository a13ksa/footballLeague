...
{
    $sql_query="DELETE FROM igraci WHERE idIgraca=".$_GET['delete_id'];
...
<head>
    ...
    if(confirm('Sigurni ste da zelite promenu podataka ?'))
        window.location.href='igraciedit.php?edit_id='+id; }
    function delete_id(id) {
    if(confirm('Da li sigurno zelite da obrisete podatak ?'))
        window.location.href='igraci.php?delete_id='+id; }
    </script>
</head>
<body>
...
<center>
    <div id="body">
        <div id="content">
            <table align="center">
            <tr>
                <th colspan="7"><a href="igraciadd.php">Dodaj podatak</a></th>
            </tr>
            <tr>
                <th>Ime</th>
                <th>Prezime</th>
            ...
            <?php
            $sql_query="SELECT * FROM igraci INNER JOIN klubovi USING(idKluba)";
