...
{
    $sql_query="DELETE FROM sudije WHERE idSudije=".$_GET['delete_id'];
...
<head>
    ...
    if(confirm('Sigurni ste da zelite promenu podataka ?'))
        window.location.href='sudijeedit.php?edit_id='+id; }
    function delete_id(id) {
    if(confirm('Da li sigurno zelite da obrisete podatak ?'))
        window.location.href='sudije.php?delete_id='+id; }
    </script>
</head>
<body>
...
<center>
    <div id="body">
        <div id="content">
            <table align="center">
            <tr>
                <th colspan="6"><a href="sudijeadd.php">Dodaj podatak</a></th>
            </tr>
            <tr>
                <th>Ime</th>
                <th>Prezime</th>
