...
if(isset($_GET['edit_id'])) {
    $sql_query="SELECT * FROM igraci WHERE idIgraca=".$_GET['edit_id'];
...
if(isset($_POST['btn-update'])) {
    ...
    $sql_query = "UPDATE igraci SET ime='$ime',prezime='$prezime',drzavljanstvo='$drzavljanstvo',datumRodjenja='$datumRodjenja',idKluba='$idKluba' WHERE idIgraca=".$_GET['edit_id'];
    // sql query for update data into database
    ...
    <script>
        ...
        window.location.href='igraci.php';
    </script>
    <?php
    } else {
    ?>
...
<div id="body">
    <div id="content">
        ...
        <tr>
            ...
            <td><input type="number" name="idKluba" placeholder="id Kluba" value="<?php echo $fetched_row['idKluba']; ?>" required /></td>
            <th><button type="submit" name="btn-update"><strong>PROMENI</strong></button></th>
        </tr>
        <tr>
            <th align="center" colspan="6"><a href="igraci.php">Povratak na glavnu stranicu</a></th>
        </tr>
        </table>
        </form>
    </div>
