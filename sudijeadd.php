...
if(isset($_POST['btn-save'])) {
    ...
    $sql_query = "INSERT INTO sudije(ime,prezime,drzavljanstvo,datumRodjenja) VALUES('$ime','$prezime','$drzavljanstvo','$datumRodjenja')";
...
<center>
    <div id="body">
        <div id="content">
            ...
            <tr >
                <th align="center" colspan="6"><a href="sudije.php">Povratak na glavnu stranicu</a></th>
            </tr>
            </table>
            </form>
        </div>
